...
def parse_args():
    ...
    parser.add_argument('pretrainCollection', type=str, help='train collection')
    ...
    # model
    parser.add_argument('--model', type=str, default='Improved_ITV_pretrain', help='model name. (default: dual_task)')
...
def main():
    ...
    pretrainCollection = opt.pretrainCollection
    ...
    opt.logger_name = os.path.join(opt.rootpath, pretrainCollection,trainCollection, opt.cv_name, valCollection, model_info, text_encode_info,
    ...
    collections = {'train': pretrainCollection, 'val': valCollection}
    cap_file = {'train': pretrainCollection+'.generate_caption.filtered.txt',
                'val': valCollection+'.caption.filtered.txt'}
    ...
    if pretrainCollection.find('WebVid')>-1:
        if  opt.textual_feature.find('CLIP_ViT-L_14_336px')>-1:
            textual_feature = 'BLIP2_txtFeatureWebVid.generate_caption.txt+CLIP_ViT-L_14_336px_txtFeatureWebVid.generate_caption.txt+imagebind_txtfeatureWebVid.generate_caption.txt'
        elif opt.textual_feature.find('CLIP_ViT-B_32')>-1:
            textual_feature ='BLIP2_txtFeatureWebVid.generate_caption.txt+CLIP_ViT-B_32_txtFeatureWebVid.generate_caption.txt+imagebind_txtfeatureWebVid.generate_caption.txt'
        else:
            NotImplemented
        textual_feat_path = {'train':os.path.join(rootpath, pretrainCollection, 'FeatureData', textual_feature),
                             'val': os.path.join(rootpath, valCollection, 'FeatureData', opt.textual_feature)}
    else:
    ...
    if opt.concept_bank=='concept' or opt.concept_bank=='concept_enhanced2':
        ...
        concept_file = os.path.join(rootpath, opt.trainCollection, 'TextData', 'concept', 'concept_frequency_count_gt' + str(
                                              opt.concept_fre_threshold)+'.lemma.stanfordnlp.enhanced2.txt')
    else:
        # ##word+phrase
    ...
    cap_prefixs = {'train':'.generate_caption','val':'.caption'}
